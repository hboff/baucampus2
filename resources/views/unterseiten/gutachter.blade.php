...
<div class="w3-col l8 s12">
  ...
  <tr>
    <td><img src="https://www.baucampus.de/Bilder/{{$gutachters['Photo']}}" style="vertical-align: middle; width: 100px; height: 100px; border-radius: 50%; object-fit: cover; object-position: center;">{{$gutachters['FirstName']}} {{$gutachters['LastName']}}</td>
