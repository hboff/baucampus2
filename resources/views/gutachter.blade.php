...
<div>
  ...
  <tr>
    <td><a  href="/gutachter/{{$gutachters['UrlName']}}" class="link-dark" target="_blank"><img src="/img/{{$gutachters['Photo']}}" style="vertical-align: middle; width: 100px; height: 100px; border-radius: 50%; object-fit: cover; object-position: center;"></a></td>
