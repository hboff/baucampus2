...
<div>
  <!-- Blog entry -->
    ...
    <img src="/img/immobilienbewertung.jpg" alt="Preise" class="pb-5" style="width:100%;min-height:350px;max-height:65vh; object-fit: cover; object-position:center;">
...
<div style="overflow-x:auto;">
  <table>
    ...
    <tr>
      <td>schriftliches Gutachten zum vorgenannten Ortstermin (schriftliche Zusammenfassung des vorgenannten Ortstermins)</td>
<td>ab 320,- € *</td>
    </tr>
...
<tr>
    ...
    <tr>
      <td>Ortstermin anlässlich eines Schimmelpilzbefalls mit einem Bausachverständigen zur mündlichen Beratung am Objekt, inkl An- und Abfahrt</td>
      <td>ab 460,- € *</td>
...
<div style="overflow-x:auto;">
  <table>
    ...
    <tr>
      <td>schriftliche Zusammenfassung der vorgenannten Hauskaufberatung</td>
      <td>ab 320,- € *</td>
   </tr>
    <tr>
      <td>Mehrfamilienhäuser, Resthöfe, etc.</td>
      <td>auf Anfrage</td>
...
<div style="overflow-x:auto;">
  <table>
    ...
    <tr>
      <td>Routinetermine während der Bauphase nach Absprache und Erfordernis (in der Regel werden je nach Bauverlauf zwischen 2 und 4 Termine benötigt)</td>
      <td>ab 610,- € *</td>
      </tr>
    <tr>
